...
module.exports = function() {
  ...
  shell.exec(`${path.resolve(__dirname, '../../node_modules/webpack-dev-server/bin/webpack-dev-server.js')} --config ${path.resolve(__dirname, '../webpack/webpack.dev.js')} --color`)
}
